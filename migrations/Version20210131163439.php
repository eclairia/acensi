 ...
 */
final class Version20210131163439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE department (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(25) NOT NULL, capacity VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
